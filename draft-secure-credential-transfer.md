...
- isPushNotificationSupported (boolean, Required) - indicates whether push notification is supported or not. Device use this boolean response to decide whether it should listen on the push topic or do long-polling.
